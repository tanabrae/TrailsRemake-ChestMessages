...
Mod(s) for _Trails_ series remakes that add the ability to interact with and read unique messages from opened treasure chests, a feature that existed in the original English PC releases. Currently supports Sky 1st.
